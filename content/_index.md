...
name = "Nuutti Kotivuori"
id = "nakedible"
bio = "Code whisperer, payment sorcerer, cloud tamer. Building secure castles in the digital sky."
avatar = "img/avatar.png"
links = [
    { name = "GitHub", icon = "github", url = "https://github.com/nakedible" },
    { name = "Twitter", icon = "twitter", url = "https://twitter.com/nakedible" },
    { name = "Email", icon = "email", url = "mailto:naked@iki.fi" },
]
